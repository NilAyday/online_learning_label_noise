...
ds_train=subloader.SubLoader(include_list=[0,1],root="./datasets", train=True, download=True, transform = torchvision.transforms.Compose([torchvision.transforms.ToTensor()]))
ds_test=subloader.SubLoader(include_list=[0,1],root="./datasets", train=False, download=True, transform = torchvision.transforms.Compose([torchvision.transforms.ToTensor()]))
